					...
					<tr>
						...
						<td>
							<c:if test="${user.perfil.equals('administrador')}">
								<a class="btn btn-danger" href="aula?action=eliminar&numaula=${aula.numaula}" role="button" onclick="return confirm('Se va a proceder a la eliminaci�n del aula. �Desea continuar?')">Eliminar</a>
							</c:if>
						</td>
					</tr>
				</c:forEach>
